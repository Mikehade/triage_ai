...
project_root = os.path.dirname(os.path.dirname(__file__))  # Go up two levels from alembic/env.py
...
logging.info("Project Root:", project_root)
logging.info("Src Path:", src_path)
...
def get_database_url():
    # Read environment variables, fallback to empty strings or defaults if you want
